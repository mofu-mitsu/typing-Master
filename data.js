...
// --- 2-2 修正分 ---
   ...
   // --- 1-3 ---
    ...
    { 
        id: "chat_ketsui_migiwa_pressure",
        subtype: "chat",
        group: "2−1",
        sender: "けつい＆みぎわ",
        start_msg:
    ...
    { 
        ...
        text: "会話を続けて。", 
        kana: "かいわをつづけて。",
        romaji: "kaiwa o tsuzukete",
        reaction_good:
            "ことり「まぁ好きにしたら」",
        reaction_bad:
            "ひとり「理解者ゼロか……」",
        images: ["kotori.png", "hitari.png"]
    },
    { 
        id: "chat_zakuro_ameri_whisper",
        subtype: "chat",
        group: "2−1",
        sender: "ざくろ＆あめり",
        start_msg:
        ...
        reaction_bad:
            "ざくろ「……違った」",
        images: ["zakuro.png", "ameri.png"]
    },
    { 
        id: "chat_jiha_iseri_noise",
        subtype: "chat",
        group: "2−1",
        sender: "じは＆いせり",
        start_msg:
        ...
        text: "声を落としてください。", 
        kana: "こえをおとしてください。",
        romaji: "koe o otoshite kudasai",
        reaction_good:
            "じは「はーい」\n" +
            "いせり「気ぃつけるわ」",
        reaction_bad:
            "いせり「無理やって！」",
        images: ["jiha.png", "iseri.png"]
    },
    { 
        id: "chat_wataru_ryogo_precision",
        subtype: "chat",
        group: "2−1",
        sender: "わたる＆りょうご",
        start_msg:
    ...
    { 
        ...
        reaction_bad:
            "まりあ「……深呼吸」",
        images: ["yuko.png", "maria.png"]
    },
    { 
        id: "chat_akira_tomoki_rival_02",
        subtype: "chat",
        group: "2−1",
        sender: "あきら＆ともき",
        start_msg:
            "ともき「なぁ牧羊犬、まだ個体値で全体語る気か？」\n" +
            "あきら「群れは質で決まる。数じゃない」\n" +
            "ともき「だから崩れる。オレは底上げする」\n" +
            "あきら「底を上げても天井は伸びない」\n" +
            "ともき「天井しか見ねぇから現場が死ぬ」\n" +
    ...
    { 
        id: "chat_akira_tomoki_rival_03",
        subtype: "chat",
        group: "2−1",
        sender: "あきら＆ともき",
        start_msg:
            "あきら「オレが嫌いなのは無責任な温情だ」\n" +
            "ともき「オレが嫌いなのは切り捨て前提の思考だ」\n" +
            "あきら「甘さは群れを腐らせる」\n" +
            "ともき「冷酷さは信頼を殺す」\n" +
            "あきら「……だから相容れねぇ」\n" +
            "ともき「だからライバルなんだろ」",
        text: "議論としては成立してるわね。", 
        kana: "ぎろんとしてはせいりつしてるわね。",
        romaji: "giron to shite wa seiritsu shiteru wa ne",
        reaction_good:
            "ともき「だろ」\n" +
            "あきら「理解はしてる」",
        reaction_bad:
    ...
    { 
        id: "chat_miriya_maria_pair",
        subtype: "chat",
        group: "2−1",
        sender: "みりや＆まりあ",
        start_msg:
            "みりや「まりあさん、本日もお疲れさまです」\n" +
            "まりあ「ふふ、みりやちゃんも。今日もクラス守ってたね」\n" +
            "みりや「役割ですので」\n" +
            "まりあ「それができるの、すごいことよ」\n" +
            "みりや「……ありがとうございます」",
        text: "仲良いですね。", 
        ...
        reaction_bad:
            "まりあ「あら、そう見えました？」\n" +
            "みりや「問題があれば対処します」",
        images: ["miriya.png", "maria.png"]
    },
    { 
        id: "chat_ameri_kotori",
        subtype: "chat",
        group: "2−1",
        sender: "あめり＆ことり",
        start_msg:
    ...
    { 
        ...
        start_msg:
            "れい「……あ」\n" +
            "れい「ごめん、またケチャップ切らしてる」\n" +
            "れい「オムライスはケチャップが本体だから」",
        text: "またケチャップ？", 
        kana: "またけちゃっぷ？",
        romaji: "mata kechappu?",
        reaction_good:
            "れい「でしょ？」\n" +
            "れい「分かってくれる人がいて助かる」",
        reaction_bad:
    ...
    { 
        ...
        start_msg:
            "ともき「弁当、真っ赤だな」\n" +
            "れい「適量よ」\n" +
            "ともき「それを適量って言うのはお前だけだ」\n" +
            "れい「統計的に見ても問題ないわ」",
        text: "机が汚れてますよ。", 
        kana: "つくえがよごれてますよ。",
        romaji: "tsukue ga yogorete masu yo",
        reaction_good:
            "れい「……拭く」\n" +
            "ともき「素直だな」",
        reaction_bad:
            "れい「授業には支障ない」\n" +
            "ともき「そういう問題じゃねぇ」",
        images: ["rei.png", "tomoki.png"]
    },
    { 
        id: "chat_ameri_kotori_fix",
        subtype: "chat",
        group: "2−1",
        sender: "あめり＆ことり",
        start_msg:
            "ことり「なぁ、人生ってもっとふわっとでよくね？」\n" +
            "あめり「……それは、ちょっと分かる」\n" +
            "ことり「やろ？」\n" +
            "あめり「でも現実が刺さってくるげんて……」",
        text: "ちゃんと授業聞いて。", 
        kana: "ちゃんとじゅぎょうきいて。",
        romaji: "chanto jugyou kiite",
        reaction_good:
            "ことり「はーい」\n" +
            "あめり「……聞く、たぶん」",
        reaction_bad:
    ...
    { 
        id: "chat_akira_tomoki_rival_04",
        subtype: "chat",
        group: "2−1",
        sender: "あきら＆ともき",
        start_msg:
            "ともき「群れを守るとか言いながら切り捨て前提だよな」\n" +
            "あきら「守るために選別する」\n" +
            "ともき「オレは全員使う」\n" +
            "あきら「理想論だ」\n" +
            "ともき「現実論だよ、犬男」\n" +
    ...
    { 
        ...
        start_msg:
            "あめり「ねぇ……あきらくん、今日も怖ない？」\n" +
            "ゆこ「ふふ、少しピリピリしてるわね」\n" +
            "あめり「近くおると、空気が張りつめとる感じする……」",
        text: "静かにね。", 
        kana: "しずかにね。",
        romaji: "shizuka ni ne",
        reaction_good:
            "あめり「……はーい」\n" +
            "ゆこ「ごめんなさい」",
        reaction_bad:
            "あめり「ひゃっ……」\n" +
            "ゆこ「気をつけるわ」",
        images: ["ameri.png", "yuko.png"]
    },
    { 
        id: "chat_akira_tomoki_rival_05",
        subtype: "chat",
        group: "2−1",
        sender: "あきら＆ともき",
        start_msg:
        ...
        text: "そこまでにしてください。", 
        kana: "そこまでにしてください。",
        romaji: "soko made ni shite kudasai",
        reaction_good:
            "ともき「……了解」\n" +
            "あきら「次は数字で話す」",
        reaction_bad:
    ...
    { 
        ...
        text: "机が汚れないように。", 
        kana: "つくえがよごれないように。",
        romaji: "tsukue ga yogorenai you ni",
        reaction_good:
            "れい「分かってる」\n" +
            "しょうご「なら安心だ」",
        reaction_bad:
            "れい「支障はないわ」\n" +
            "しょうご「理屈は完璧だね……」",
        images: ["rei.png", "shogo.png"]
    },
    { 
        id: "chat_hitori_wataru_tension",
        subtype: "chat",
        group: "2−1",
        sender: "ひとり＆わたる",
        start_msg:
        ...
        reaction_bad:
            "ひとり「止められん……！」\n" +
            "わたる「強制的に止める」",
        images: ["hitori.png", "wataru.png"]
    },
    { 
        id: "chat_ameri_rei_soft",
        subtype: "chat",
        group: "2−1",
        sender: "あめり＆れい",
        start_msg:
        ...
        reaction_bad:
            "れい「誤解よ」\n" +
            "あめり「そ、そっか……」",
        images: ["ameri.png", "rei.png"]
    },
    { 
        id: "chat_rei_migiwa_order",
        subtype: "chat",
        group: "2−1",
        sender: "れい＆みぎわ",
        start_msg:
        ...
        reaction_bad:
            "みぎわ「詰め甘かった？」\n" +
            "れい「修正する」",
        images: ["rei.png", "migiwa.png"]
    },
    { 
        id: "chat_ameri_shogo_soft",
        subtype: "chat",
        group: "2−1",
        sender: "あめり＆しょうご",
        start_msg:
        ...
        reaction_bad:
            "あめり「……恥ずかしい」\n" +
            "しょうご「あ、ごめん」",
        images: ["ameri.png", "shogo.png"]
    },
    { 
        id: "chat_miriya_wataru_guard",
        subtype: "chat",
        group: "2−1",
        sender: "みりや＆わたる",
        start_msg:
    ...
    { 
        ...
        reaction_bad:
            "ひとり「抑えきれん！」\n" +
            "じは「やば」",
        images: ["hitori.png", "jiha.png"]
    },
    { 
        id: "chat_zakuro_ryogo_quiet",
        subtype: "chat",
        group: "2−1",
        sender: "ざくろ＆りょうご",
        start_msg:
    ...
    { 
        ...
        reaction_bad:
            "ことり「まだいける」\n" +
            "いせり「逃げよ！」",
        images: ["kotori.png", "isery.png"]
    },
    { 
        id: "chat_maria_yuko_calm",
        subtype: "chat",
        group: "2−1",
        sender: "まりあ＆ゆこ",
        start_msg:
    ...
    { 
        id: "chat_rei_migiwa_pair",
        subtype: "chat",
        group: "2−1",
        sender: "れい＆みぎわ",
        start_msg:
            "れい「そこ、計算式の前提がズレてるわ」\n" +
            "みぎわ「え、でも先生が言うとったのはこの条件じゃろ？」\n" +
            "れい「条件は合ってる。でも代入の順番が違う」\n" +
            "みぎわ「……あ、ほんまじゃ。先にこれ外すんか」\n" +
            "れい「そう。落ち着けば簡単よ」",
        text: "もう一度確認します。", 
        kana: "もういちどかくにんします。",
        romaji: "mou ichido kakunin shimasu",
        reaction_good:
            "みぎわ「さすがれいちゃんじゃな……頭ええわ」\n" +
            "れい「普通に見直しただけよ」",
        reaction_bad:
            "れい「先生、そこ誤字があるわ」\n" +
            "みぎわ「それ先に言うてくれんと混乱するけぇ」",
        images: ["rei.png", "migiwa.png"]
    },
    { 
        id: "chat_ameri_shogo_soft",
        ...
        sender: "あめり＆しょうご",
        start_msg:
            "しょうご「その色合わせ、あめりちゃんらしいな」\n" +
            "あめり「ほ、ほんと……？派手すぎんかな……」\n" +
            "しょうご「全然。優しい感じでいいと思う」\n" +
            "あめり「……そ、そう言われると安心する」",
        text: "続けてください。", 
        kana: "つづけてください。",
        romaji: "tsudzukete kudasai",
        reaction_good:
            "あめり「……がんばる、ね」\n" +
            "しょうご「うん、その調子」",
        reaction_bad:
    ...
    { 
        id: "chat_ameri_mikina_pair",
        subtype: "chat",
        group: "2−1",
        sender: "あめり＆みきな",
        start_msg:
            "みきな「その発想かわいいね。夢の中みたい」\n" +
            "あめり「そ、そうかな……ちょっと不安で」\n" +
            "みきな「大丈夫。あめりちゃんの世界観、好きだよ」\n" +
            "あめり「……えへへ」",
        text: "私語は控えて。", 
        kana: "しごはひかえて。",
        ...
        reaction_good:
            ...
            "あめり「う、うん……」",
        reaction_bad:
            "みきな「先生、今の注意ちょっとズレてない？」\n" +
            "あめり「……タイミング違う気、する」",
        images: ["ameri.png", "mikina.png"]
    },
    { 
        id: "chat_hitomi_kotori_light",
        subtype: "chat",
        group: "2−1",
        sender: "ひとり＆ことり",
        start_msg:
        ...
        reaction_bad:
            "ひとり「先生、誤字で結界が乱れている」\n" +
            "ことり「普通に打ち間違いね、それ」",
        images: ["hitomi.png", "kotori.png"]
    },
    { 
        id: "chat_akira_wataru_tense",
        subtype: "chat",
        group: "2−1",
        sender: "あきら＆わたる",
        start_msg:
        ...
        reaction_bad:
            "あきら「先生、そこ定義が抜けてる」\n" +
            "わたる「そのままだと誤解を生む」",
        images: ["akira.png", "wataru.png"]
    },
    { 
        id: "chat_ketsui_migiwa_deck",
        subtype: "chat",
        group: "2−1",
        sender: "けつい＆みぎわ",
        start_msg:
            "けつい「今日は潮がええ感じじゃけぇ、集中できるで」\n" +
            "みぎわ「授業で潮の話せんでええんよ！」\n" +
            "けつい「まぁまぁ、流れ読むんは一緒じゃろ」\n" +
            "みぎわ「例えが強引すぎるわ」",
        text: "静かにしなさい。", 
        kana: "しずかにしなさい。",
        romaji: "shizuka ni shinasai",
        reaction_good:
            ...
            "けつい「ほい、続きやるで」",
        reaction_bad:
            "みぎわ「先生、その漢字間違うと意味変わるけぇ」\n" +
            "けつい「そこ打ち間違えとるで」",
        images: ["ketsui.png", "migiwa.png"]
    },
    { 
        id: "chat_yuko_rei_analysis",
        subtype: "chat",
        group: "2−1",
        sender: "ゆこ＆れい",
        start_msg:
            "ゆこ「その視点、確かに合理的だけど……」\n" +
            "れい「感情要素を切り捨てすぎると反発が出るわ」\n" +
            "ゆこ「……やっぱりそこ、気になるよね」\n" +
            "れい「ええ。数字だけでは人は動かないもの」",
        text: "話し合いは後に。", 
        kana: "はなしあいはあとに。",
        romaji: "hanashiai wa ato ni",
        reaction_good:
            "れい「了解」\n" +
            "ゆこ「後で続きをしましょ」",
        reaction_bad:
            "れい「先生、今の説明一文抜けてるわ」\n" +
            "ゆこ「そこ補足しないと誤解されます」",
        images: ["yuko.png", "rei.png"]
    },
    { 
        id: "chat_iseri_jihachan_noise",
        subtype: "chat",
        group: "2−1",
        sender: "いせり＆じは",
        start_msg:
    ...
    { 
        ...
        reaction_bad:
            "ひとり「先生、誤字が世界を歪めている」\n" +
            "ことり「普通にタイプミスね」",
        images: ["kotori.png", "hitomi.png"]
    },
    { 
        id: "chat_ryogo_shogo_logic",
        subtype: "chat",
        group: "2−1",
        sender: "りょうご＆しょうご",
        start_msg:
            "りょうご「この構造、無駄が一個あるな」\n" +
            "しょうご「ほんとだ。そこ削れば流れ良くなる」\n" +
            "りょうご「気づくの早いな」\n" +
            "しょうご「りょうごの視点が細かいからさ」",
        text: "相談は静かに。", 
        kana: "そうだんはしずかに。",
        romaji: "soudan wa shizuka ni",
        reaction_good:
            "しょうご「了解です」\n" +
            "りょうご「このまま進めるか」",
        reaction_bad:
            "りょうご「先生、そこ文字抜けてる」\n" +
            "しょうご「今のだと意味ズレますね」",
        images: ["ryogo.png", "shogo.png"]
    },
    { 
        id: "chat_mikina_jiha_chaos",
        subtype: "chat",
        group: "2−1",
        sender: "みきな＆じは",
        start_msg:
            "じは「ねぇねぇ、今めっちゃヒマなんだけど！」\n" +
            "みきな「今それ言う？タイミング最悪」\n" +
            "じは「でもヒマなもんはヒマ！」\n" +
            "みきな「自由すぎでしょ」",
        text: "授業に集中。", 
        kana: "じゅぎょうにしゅうちゅう。",
        romaji: "jugyou ni shuuchuu",
        reaction_good:
            "みきな「はいはい」\n" +
            "じは「はーい」",
        reaction_bad:
            "じは「先生、誤字ってるで！」\n" +
            "みきな「そこ普通に打ちミス」",
        images: ["mikina.png", "jiha.png"]
    },
    { 
        id: "chat_ameri_mikina_soft",
        subtype: "chat",
        group: "2−1",
        sender: "あめり＆みきな",
        start_msg:
    ...
    { 
        ...
        reaction_bad:
            "れい「先生、その表現曖昧よ」\n" +
            "まりあ「ちょっと誤解されそう」",
        images: ["maria.png", "rei.png"]
    },
    { 
        id: "chat_kotori_iseri_escape",
        subtype: "chat",
        group: "2−1",
        sender: "ことり＆いせり",
        start_msg:
        ...
        reaction_bad:
            "ことり「先生、誤字バレてるよ」\n" +
            "いせり「そこちゃう意味になるで！」",
        images: ["kotori.png", "iseri.png"]
    },
    { 
        id: "chat_hitori_kotori",
        subtype: "chat",
        group: "2−1",
        sender: "ひとり＆ことり",
        start_msg:
            "ひとり「……今、左腕が疼いてる。嵐の前触れだ」\n" +
            "ことり「また始まった。湿布貼っとき？」\n" +
            "ひとり「貴様にはこの高次元の感覚がわからん」\n" +
            "ことり「はいはい、高次元高次元。昼寝の時間だぞー」",
        text: "静かにしなさい。", 
        kana: "しずかにしなさい。",
        romaji: "shizuka ni shinasai",
        reaction_good:
        ...
        reaction_bad:
            "ひとり「詠唱が乱れている」\n" +
            "ことり「タイプミス多くない？先生も寝不足？」",
        images: ["hitori.png", "kotori.png"]
    },
    { 
        id: "chat_ketsui_migiwa",
        subtype: "chat",
        group: "2−1",
        sender: "けつい＆みぎわ",
        start_msg:
            ...
            "けつい「落ち着けって。船は逃げん」",
        text: "教室では船の話は禁止です。", 
        kana: "きょうしつではふねのはなしは禁止です。",
        romaji: "kyoushitsu de wa fune no hanashi wa kinshi desu",
        reaction_good:
            "けつい「すんません先生」\n" +
            "みぎわ「……あとで続きじゃな」",
        reaction_bad:
    ...
    { 
        ...
        reaction_bad:
            "れい「先生、誤字」\n" +
            "あきら「論点ズレてる」",
        images: ["akira.png", "rei.png"]
    },
    { 
        id: "chat_miriya_tomoki",
        subtype: "chat",
        group: "2−1",
        sender: "みりや＆ともき",
        start_msg:
        ...
        reaction_bad:
            "ともき「先生、タイプミス」\n" +
            "みりや「文章が乱れています」",
        images: ["miriya.png", "tomoki.png"]
    },
    { 
        id: "chat_iseri_jiha_2",
        subtype: "chat",
        group: "2−1",
        sender: "いせり＆じは",
        start_msg:
    ...
    { 
        ...
        start_msg:
            ...
            "れい「その理屈、極端すぎ」",
        text: "成績について静かにしなさい。", 
        kana: "せいせきについてしずかにしなさい。",
        romaji: "seiseki ni tsuite shizuka ni shinasai",
        reaction_good:
            "ともき「了解」\n" +
            "れい「失礼しました」\n" +
            "あきら「……はい」",
    ...
    { 
        ...
        reaction_bad:
            "ことり「先生、字おかしかばい」\n" +
            "じは「誤字で説教すな」",
        images: ["jiha.png", "hitori.png", "kotori.png"]
    },
    { 
        id: "chat_test_support",
        subtype: "chat",
        group: "2−1",
        sender: "まりあ＆みりや",
        start_msg:
        ...
        reaction_bad:
            "みりや「先生、文法が乱れています」\n" +
            "まりあ「意味が通りません」",
        images: ["maria.png", "miriya.png"]
    },
    { 
        id: "chat_top_vs_kotori",
        subtype: "chat",
        group: "2−1",
        sender: "れい＆ともき＆あきら＆ことり",
        start_msg:
            "れい「今回の問題、素直だったよね」\n" +
            "ともき「ケアレスミス減らせば満点狙えた」\n" +
            "あきら「難易度は低い」\n" +
            "ことり「……はいはい、天才様ばっかでよかばい」\n" +
            "ともき「拗ねんな」\n" +
            "ことり「拗ねとらん。元から低空飛行たい」",
        text: "無駄話はやめなさい。", 
        kana: "むだばなしはやめなさい。",
        romaji: "mudabanashi wa yame nasai",
        reaction_good:
            "れい「ごめんなさい」\n" +
            "ともき「了解」\n" +
            "あきら「……」\n" +
        ...
        reaction_bad:
            "ことり「先生、誤字ばい」\n" +
            "ともき「そこ間違える？」",
        images: ["rei.png", "tomoki.png", "akira.png", "kotori.png"]
    },
    { 
        id: "chat_tomoki_jiha_execution",
        subtype: "chat",
        group: "2−1",
        sender: "ともき＆じは",
        start_msg:
        ...
        reaction_bad:
            "じは「先生、変換ミスしとるで」\n" +
            "ともき「説教前に直して」",
        images: ["tomoki.png", "jiha.png"]
    },
    { 
        id: "chat_suibeibu_test",
        subtype: "chat",
        group: "2−1",
        sender: "けつい＆みぎわ＆りょうご",
        start_msg:
            ...
            "けつい「それでええ。船はチームじゃ」",
        text: "部活動の話は後にしなさい。", 
        kana: "ぶかつどうのはなしはあとにしなさい。",
        romaji: "bukatsudou no hanashi wa ato ni shinasai",
        reaction_good:
            "けつい「了解じゃ」\n" +
            "みぎわ「すみません！」\n" +
            "りょうご「わかった」",
    ...
    { 
        ...
        reaction_bad:
            "みきな「先生、助詞おかしい」\n" +
            "ざくろ「文として変」",
        images: ["mikina.png", "ameri.png", "zakuro.png"]
    },
    { 
        id: "chat_study_suibeibu_math",
        subtype: "chat",
        group: "2−1",
        sender: "りょうご＆けつい＆みぎわ",
        start_msg:
            "りょうご「じゃ、まず数学からでいい？」\n" +
            "けつい「別にええで。ワシのノートここじゃ」\n" +
            "みぎわ「……りょうご、今日やけにやる気じゃろ」\n" +
            "りょうご「いや、普通。2人落ちたら面倒だから」\n" +
            "みぎわ「素直に心配しとるって言えぇや！」\n" +
            "けつい「ワシは落ちんて。たぶん」\n" +
            "りょうご「“たぶん”禁止」",
        text: "勉強を始めなさい。", 
        kana: "べんきょうをはじめなさい。",
        romaji: "benkyou wo hajime nasai",
        reaction_good:
            "りょうご「ほら、二次関数な。最大最小はグラフ描いた方が早い」\n" +
            "けつい「ほぉん……」",
        reaction_bad:
            "みぎわ「先生、字抜けとる！」\n" +
            "けつい「誤字多いで、落ち着きんさい」",
        images: ["ryogo.png", "ketsui.png", "migiwa.png"]
    },
    { 
        id: "chat_study_whiteboard",
        subtype: "chat",
        group: "2−1",
        sender: "りょうご",
        start_msg:
            "りょうご「これな、文章長いけどビビらなくていい」\n" +
            "りょうご「要点3つ拾えば解ける」\n" +
            "みぎわ「無理！！なんなんこの問題！！」\n" +
            "みぎわ「うちを殺す気かぁ！？」\n" +
            "けつい「ワシの心、エビみたいにスーッと抜けてった」\n" +
            "りょうご「またエビの例え出た…」",
        text: "集中しなさい。", 
        kana: "しゅうちゅうしなさい。",
        romaji: "shuuchuu shinasai",
        ...
        reaction_bad:
            "りょうご「先生、変換ミス」\n" +
            "みぎわ「そこ違うで！」",
        images: ["ryogo.png", "migiwa.png", "ketsui.png"]
    },
    { 
        id: "chat_study_breakdown",
        subtype: "chat",
        group: "2−1",
        sender: "けつい＆みぎわ",
        start_msg:
    ...
    { 
        ...
        start_msg:
            ...
            "みぎわ「うちを殺す気かぁ！？」\n" +
            "けつい「出たわ、岡山の荒ぶる鳥」\n" +
            "りょうご「鳴き声で集中切れるから静かにして」\n" +
            "みぎわ「誰が鳥じゃ！」",
        text: "落ち着いて解きなさい。", 
        kana: "おちついてときなさい。",
        romaji: "ochitsuite toki nasai",
        reaction_good:
            "りょうご「ほら、条件ここだけ見て」\n" +
            "みぎわ「……ちょっと分かったのが悔しい」",
        reaction_bad:
            "けつい「先生、漢字ミスっとるで」\n" +
            "みぎわ「説得力なくなるやつ！」",
        images: ["migiwa.png", "ketsui.png", "ryogo.png"]
    },
    { 
        id: "chat_top3_study_start",
        subtype: "chat",
        group: "2−1",
        sender: "れい＆ともき＆あきら",
        start_msg:
            "れい「じゃ、確認するね。ここ出る」\n" +
            "ともき「説明いらん。結論だけ言え」\n" +
            "あきら「いや、過程確認しろ。油断が一番の無駄だ」\n" +
            "ともき「結果出てりゃ十分だろ」\n" +
            "れい「はいはい、2人とも正しい」",
        text: "協力して進めなさい。", 
        kana: "きょうりょくしてすすめなさい。",
        romaji: "kyouryoku shite susume nasai",
        reaction_good:
            "れい「この式、途中省略していい」\n" +
            "ともき「時間短縮だな」",
        reaction_bad:
    ...
    { 
        ...
        start_msg:
            "あきら「この問題、迷う要素あるか？」\n" +
            "ともき「ない。引っかかるやつは準備不足」\n" +
            "れい「でもクラス的にはここ落とす人多いよ」\n" +
            "ともき「だから平均が下がる」\n" +
            "あきら「……切り捨てるな」",
        text: "全体も意識しなさい。", 
        kana: "ぜんたいもいしきしなさい。",
        romaji: "zentai mo ishiki shinasai",
        reaction_good:
            "れい「じゃあ、説明用の言い換え考えるね」\n" +
            "あきら「それでいい」",
        reaction_bad:
    ...
    { 
        id: "chat_top3_ryogo_airdeath",
        subtype: "chat",
        group: "2−1",
        sender: "れい＆ともき＆あきら＆りょうご",
        start_msg:
            "りょうご「……あの、僕も一緒にやっていい？」\n" +
            "ともき「別に止めねぇけど」\n" +
            "あきら「理解速度についてこれるならな」\n" +
    ...
    { 
        id: "chat_bottom3_before_test",
        subtype: "chat",
        group: "2−1",
        sender: "じは＆ひとり＆ことり",
        start_msg:
            "じは「なぁ、明日テストらしいで」\n" +
            "ひとり「フッ……俺の左腕が疼く理由はそれか」\n" +
            "ことり「まぁ、なるようになるっちゃろ」\n" +
            "じは「ノートどこいったか分からん」\n" +
            "ひとり「俺様は心で理解するタイプだからな」\n" +
            "ことり「勉強する気出る音楽探しよる」\n" +
            "じは「それもう負けやろ」",
        text: "テスト勉強をしなさい。", 
        kana: "てすとべんきょうをしなさい。",
        romaji: "tesuto benkyou o shinasai",
        reaction_good:
            "ことり「……5分だけやる」\n" +
            "じは「短っ！」",
        reaction_bad:
            "ひとり「先生、漢字間違っとる」\n" +
            "じは「注意する側がそれはアカンわ！」",
        images: ["jiha.png", "hitari.png", "kotori.png"]
    },
    { 
        id: "chat_bottom3_study_fail",
        subtype: "chat",
        group: "2−1",
        sender: "じは＆ひとり＆ことり",
        start_msg:
            "じは「奇跡じゃね？この三人で勉強会とか」\n" +
            "ひとり「フッ……我が左腕が静かなうちに始めるぞ」\n" +
            "ことり「10分だけな。それ以上は人権侵害やけん」\n" +
            "じは「じゃあ英語からいこ〜」\n" +
            "ひとり「待て。まず世界史だ。昨日、闇の夢で見た」\n" +
            "ことり「その夢、テスト範囲？」\n" +
            "じは「ねぇノートどこ？カバンの中ブラックホールなんだけど」\n" +
            "ひとり「……左腕が疼いてきた」\n" +
            "ことり「はい解散〜。もう10分経った気がする」",
        text: "集中して勉強を続けなさい。", 
        kana: "しゅうちゅうしてべんきょうをつづけなさい。",
        romaji: "shuuchuu shite benkyou o tsuzuke nasai",
        reaction_good:
            "じは「え、先生見てたん？」\n" +
            "ひとり「チッ……監視者か」\n" +
            "ことり「まぁ…あと5分なら…」",
    ...
    { 
        id: "chat_ryogo_teaching_drain",
        subtype: "chat",
        group: "2−1",
        sender: "りょうご＆じは＆ひとり＆ことり",
        start_msg:
            "りょうご「じゃ、基礎から説明するね」\n" +
            "じは「基礎ってどこから？」\n" +
            "ひとり「オレの左腕は基礎を拒んでいる」\n" +
            ...
            "ことり「りょうご、顔色悪くなっとるばい」\n" +
            "りょうご「……大丈夫、続ける」",
        text: "その調子で説明を続けてください。", 
        kana: "そのちょうしでせつめいをつづけてください。",
        romaji: "sono choushi de setsumei o tsuzukete kudasai",
        reaction_good:
            "りょうご「はい……続けます」\n" +
            "じは「えら」\n" +
            "ことり「尊敬はする」",
        reaction_bad:
            ...
            "ひとり「集中力が削がれる」\n" +
            "じは「HP削られるやつ」",
        images: ["ryogo.png", "jiha.png", "hitori.png", "kotori.png"]
    },
    { 
        id: "chat_testday_chaos",
        subtype: "chat",
        group: "2−1",
        sender: "ことり＆じは＆ひとり",
        start_msg:
            ...
            "ことり「まぁ赤点でも人生は続くし」",
        text: "私語をやめて試験を始めなさい。", 
        kana: "しごをやめてしけんをはじめなさい。",
        romaji: "shigo o yamete shiken o hajime nasai",
        reaction_good:
            "じは「はーい…」\n" +
            "ひとり「沈黙こそ力」\n" +
            "ことり「はいはい、現実に戻ります」",
        reaction_bad:
            ...
            "じは「先生、焦ってる？」\n" +
            "ことり「それじゃ集中できんばい」",
        images: ["kotori.png", "jiha.png", "hitori.png"]
    },
    { 
        id: "chat_ryogo_hp_critical",
        subtype: "chat",
        group: "2−1",
        sender: "りょうご＆じは＆ひとり＆ことり",
        start_msg:
        ...
        reaction_bad:
            ...
            "ひとり「集中が削がれる」\n" +
            "ことり「HPさらに減るばい」",
        images: ["ryogo.png", "akira.png"]
    },
    { 
        id: "chat_ketsui_oneword_magic",
        subtype: "chat",
        group: "2−1",
        sender: "りょうご＆けつい＆下位3人",
        start_msg:
            "りょうご「だから、ここは前提条件を整理して……」\n" +
            "じは「前提ってテンション？」\n" +
            "ひとり「俺の左腕が拒絶している」\n" +
            "ことり「眠くなってきたばい」\n" +
            "（沈黙）\n" +
            ...
            "りょうご「……」",
        text: "簡潔に説明してください。", 
        kana: "かんけつにせつめいしてください。",
        romaji: "kanketsu ni setsumei shite kudasai",
        reaction_good:
            "けつい「ほら、難しゅう考えすぎ」\n" +
            "りょうご「……ありがとう」",
        reaction_bad:
            "けつい「先生、そこ助詞抜けとる」\n" +
            "りょうご「意味が曖昧になります」",
        images: ["ketsui.png", "ryogo.png"]
    },
    { 
        id: "chat_test_return_bottom3",
        subtype: "chat",
        group: "2−1",
        sender: "じは＆ひとり＆ことり",
        start_msg:
            ...
            "ひとり「運命だ。俺は抗わない」\n" +
            "（答案返却）\n" +
            "じは「なぁこれ、設問と会話してるって言われた」\n" +
            "ことり「全部感想書いた」\n" +
            "ひとり「余白に覚醒過程を記した」",
        text: "答案は丁寧に書きましょう。", 
        kana: "とうあんはていねいにかきましょう。",
        romaji: "touan wa teineini kakimashou",
        reaction_good:
            "ことり「まぁ読めたなら勝ちやろ」\n" +
            "じは「先生優しい」",
        reaction_bad:
            "ひとり「先生、漢字違う」\n" +
            "じは「そこツッコむ？」",
        images: ["jihya.png", "hitri.png", "kotori.png"]
    },
    { 
        id: "chat_top_one_comment",
        subtype: "chat",
        group: "2−1",
        sender: "あきら＆ともき",
        start_msg:
    ...
    { 
        id: "chat_final_report_announce",
        subtype: "chat",
        group: "2−1",
        sender: "先生",
        start_msg:
            "先生「期末レポートは自由テーマ。\n　文字数は2000字以上、引用明記必須です」\n" +
            "じは「自由って一番むずいやつやん」\n" +
            "ことり「2000字って気合い入れたら1時間やろ」\n" +
            "ひとり「……運命が俺に試練を与えている」\n" +
            "りょうご「（もう嫌な予感してる）」",
        text: "質問はありますか。", 
        kana: "しつもんはありますか。",
        romaji: "shitsumon wa arimasu ka",
        reaction_good:
            "りょうご「提出形式はPDFで大丈夫ですか」\n" +
            "先生「はい」",
        reaction_bad:
            "先生「今のは誤字です」\n" +
            "じは「先生も事故るんや」",
    ...
    { 
        ...
        start_msg:
            ...
            "ひとり「それは運命への冒涜だ」",
        text: "テーマは自分で考えましょう。", 
        kana: "てーまはじぶんでかんがえましょう。",
        romaji: "teema wa jibun de kangaemashou",
        reaction_good:
            "ことり「じゃあAIについて書く」\n" +
            "じは「逆に潔い」",
        reaction_bad:
    ...
    { 
        ...
        text: "落ち着いて聞いてください。", 
        kana: "おちついてきいてください。",
        romaji: "ochitsuite kiite kudasai",
        reaction_good:
            "りょうご「……順番にいこう」\n" +
            "けつい「無理すんな」",
        reaction_bad:
    ...
    { 
        ...
        text: "締切を守ってください。", 
        kana: "しめきりをまもってください。",
        romaji: "shimekiri o mamotte kudasai",
        reaction_good:
            "じは「間に合った！」\n" +
            "ことり「奇跡や」",
        reaction_bad:
    ...
    { 
        ...
        reaction_bad:
            "あきら「先生、敬語が崩れてる」\n" +
            "ともき「疲れてます？」",
        images: ["akira.png", "tomoki.png", "rei.png"]
    },
    {
        id: "chat_report_titles_strange",
        subtype: "chat",
        group: "2−1",
        sender: "クラス一同",
        start_msg:
            "ひとり「今回のレポ、タイトルで世界を震わせてやった」\n" +
            "みきな「不安になる前振りやめて？」\n" +
            "あめり「うちの…ちょっと変かもしれんけど……」\n" +
            "ことり「楽して書いた結果、哲学になった」\n" +
            "ともき「タイトルでふざけるな」\n" +
            "あきら「内容と整合性が取れていれば問題ない」\n" +
            "ひとり「俺の左腕が“詩的であれ”って囁いた」",
        text: "提出されたレポートのタイトルを読み上げます。", 
        kana: "ていしゅつされたれぽーとのたいとるをよみあげます。",
        romaji: "teishutsu sareta repooto no taitoru o yomiagemasu",
        reaction_good:
            "みきな「ちょ、想像以上にカオスなんだけど」\n" +
            "ともき「……読む前から嫌な予感しかしない」",
        reaction_bad:
            "あきら「先生、読み間違いがあります」\n" +
            "ともき「誤字ったまま読むのはどうなんだ」",
    ...
    {
        id: "chat_report_grading_log",
        subtype: "chat",
        group: "2−1",
        sender: "先生",
        start_msg:
            "先生「内容は理解できましたが、論点が散漫です」\n" +
            "先生「着眼点は良いですが、裏付けが不足しています」\n" +
            "先生「独創性はありますが、課題意図から逸脱しています」\n" +
            "先生「次回は“要約”を意識してください」\n" +
            "先生「これは感想文ではありません」\n" +
            "先生「最後まで読ませる力はあります」",
        text: "採点コメントを確認してください。", 
        kana: "さいてんこめんとをかくにんしてください。",
        romaji: "saiten komento o kakunin shite kudasai",
        reaction_good:
            "しょうご「なるほど…改善点が明確ですね」\n" +
            "れい「次は構成を意識すればもっと良くなるわ」",
        reaction_bad:
            "れい「先生、そこ一文字抜けてます」\n" +
            "ともき「誤字ったコメントは説得力下がる」",
        images: [
    ...
    },
    {
        ...
        start_msg:
            "ことり「いや〜、思ったより点あった」\n" +
            "ひとり「フッ…評価など些細なもの」\n" +
            "いせり「オレ、提出しただけで勝ちや思てるで？」\n" +
            "ことり「内容はともかく、出したのえらい」\n" +
            "ひとり「左腕も満足している」\n" +
            "いせり「先生、なんかいっぱい書いてくれてたし！」",
        text: "結果についてどう思いますか？", 
        kana: "けっかについてどうおもいますか。",
        romaji: "kekka ni tsuite dou omoimasu ka",
        reaction_good:
            "ことり「そうやろ？前向き大事」\n" +
            "いせり「次もこの調子でいくわ！」",
        reaction_bad:
    ...
    },
    {
        ...
        text: "静かに聞いてください。", 
        kana: "しずかにきいてください。",
        romaji: "shizuka ni kiite kudasai",
        reaction_good:
            "ゆこ「次はもう少し対策が必要ですね」\n" +
            "みぎわ「これは反省会案件じゃな…」",
        reaction_bad:
    ...
    {
        id: "chat_akira_tomoki_silent_gap",
        subtype: "chat",
        group: "2−1",
        sender: "あきら＆ともき",
        start_msg:
    ...
    {
        id: "chat_post_announcement_whispers",
        subtype: "chat",
        group: "2−1",
        sender: "クラスメイト",
        start_msg:
    ...
    },
    {
        ...
        text: "片付けてから帰りましょう。", 
        kana: "かたづけてからかえりましょう。",
        romaji: "katazukete kara kaerimashou",
        reaction_good:
            "れい「すぐ片付けます」",
        reaction_bad:
            "れい「先生、“片付け”の送り仮名が違います」\n" +
            "みきな「さすが即ツッコミ」",
        images: [
            "rei.png",
            "mikina.png",
    ...
    {
        id: "chat_report_hp_zero_ryogo",
        subtype: "chat",
        group: "2−1",
        sender: "りょうご",
        start_msg:
            "りょうご「……じゃあ、ここは前提を整理すると」\n" +
            "じは「え、もう一回言って？」\n" +
            "ひとり「フッ……俺の左腕が拒否している」\n" +
            "ことり「だいたいわかった気がする」\n" +
            "りょうご「……“だいたい”は一番危険で」\n" +
    ...
    {
        id: "chat_lower_three_after_return",
        subtype: "chat",
        group: "2−1",
        sender: "下位3人",
        start_msg:
        ...
        text: "反省はしていますか。", 
        kana: "はんせいはしていますか。",
        romaji: "hansei wa shiteimasu ka",
        reaction_good:
            "ことり「一応は」",
        reaction_bad:
            "ひとり「先生、“反省”とは魂の内省だ」\n" +
    ...
    {
        id: "chat_bonus_akira_tomoki_stare",
        subtype: "chat",
        group: "2−1",
        sender: "あきら＆ともき",
        start_msg:
    ...
    },
    {
        ...
        text:
            ...
            "これは感情論ではない。\n" +
            "効率と持続性の話だ。",
        kana: "ぼくようけんからみたしゃかいこうぞう",
        romaji: "bokuyouken kara mita shakai kouzou",
        reaction_good:
            "あきら「……理解されたなら、それでいいです」",
        reaction_bad:
            "あきら「誤字以前に、論点読み違えてません？」",
        images: ["akira.png"]
    },
    {
        id: "report_kotori_001",
        subtype: "report",
        group: "2−1",
        sender: "ことり",
        start_msg:
        ...
        text:
            ...
            "だから今回は、\n" +
            "書かないという選択肢を検討した。\n\n" +
            "……が、提出しないと単位が消えるので書いている。\n\n" +
            "結論。\n" +
            "書かない自由は存在するが、\n" +
            "その代償は高い。",
        kana: "れぽーとをかかないというせんたくし",
        romaji: "repooto o kakanai to iu sentakushi",
        reaction_good:
            "ことり「まぁ、そういうこと」",
        reaction_bad:
            "ことり「先生、設問読んでから評価して」",
    ...
    },
    {
        ...
        text:
            ...
            "本来、レポートは理性で書くものだが、\n" +
            "直感を無視するのは二流だ。\n\n" +
            "よって、この文章は左腕主導で構成されている。\n\n" +
            "疼きが止まった時点で、\n" +
            "内容は完成していた。\n\n" +
            "以上。",
        kana: "ひだりうでがうずいたのでていしゅつしました",
        romaji: "hidari ude ga uzuita node teishutsu shimashita",
        reaction_good:
            "ひとり「ふっ……理解者か」",
        reaction_bad:
            "ひとり「誤字？それも運命だろ」",
    ...
    },
    {
        ...
        text:
            ...
            "つまり、\n" +
            "ゆめかわは経済活動の一部。",
        kana: "ゆめかわしそうとげんだいけいざい",
        romaji: "yumekawa shisou to gendai keizai",
        reaction_good:
            "あめり「よ、よかったです……」",
        reaction_bad:
            "あめり「先生……読み飛ばしてませんか……？」",
    ...
    { 
        ...
        start_msg:
            ...
            "あきら「最初から詰めている」",
        text: "点数について何かありますか？",
        kana: "てんすうについてなにかありますか？",
        romaji: "tensuu ni tsuite nanika arimasu ka",
        reaction_good:
            "ともき「いえ。次は満点取ります」\n" +
            "あきら「以上です」",
        reaction_bad:
    ...
    {
        id: "chat_ketsui_migiwa_report",
        subtype: "chat",
        group: "2−1",
        sender: "けつい＆みぎわ",
        start_msg:
            "みぎわ「部活とレポート被せるんやめてほしいわ！」\n" +
            "けつい「まぁまぁ。潮の流れ読むみたいなもんじゃ」\n" +
            "みぎわ「意味わからん例え出すなや！」",
        text: "提出状況を確認します。",
        kana: "ていしゅつじょうきょうをかくにんします。",
        romaji: "teishutsu joukyou wo kakunin shimasu",
        reaction_good:
            "けつい「ちゃんと出しとるで」\n" +
            "みぎわ「形式も守っとる！」",
        reaction_bad:
    ...
    },
    {
        ...
        start_msg:
            ...
            "じは「理解したくもな〜い」",
        text: "内容について説明できますか？",
        kana: "ないようについてせつめいできますか？",
        romaji: "naiyou ni tsuite setsumei dekimasu ka",
        reaction_good:
            "ひとり「……闇の必然だ」\n" +
            "じは「うん先生スルーでいいよそれ」",
        reaction_bad:
    ...
    },
    {
        ...
        text: "発表を続けてください。",
        kana: "はっぴょうをつづけてください。",
        romaji: "happyou wo tsudzukete kudasai",
        reaction_good:
            "ざくろ「……以上です」\n" +
            "あめり「……ありがとうございました」",
        reaction_bad:
    ...
    },
    {
        ...
        start_msg:
            ...
            "ことり「出しただけ褒めてほしか〜」",
        text: "提出意図を教えてください。",
        kana: "ていしゅついとをおしえてください。",
        romaji: "teishutsu ito wo oshiete kudasai",
        reaction_good:
            "しょうご「最低限は満たしてます」\n" +
            "ことり「まぁ、及第点っちことで」",
        reaction_bad:
            "ことり「先生、誤字っとーばい」\n" +
            "しょうご「確認お願いします」",
        images: ["kotori.png", "shogo.png"]
    },
    {
        id: "chat_rei_yuko_fullmark",
        subtype: "chat",
        group: "2−1",
        sender: "れい＆ゆこ",
        start_msg:
            "ゆこ「……満点？」\n" +
            "れい「うん。ケチャップで集中力上がったわ」\n" +
            "ゆこ「理由そこなの……？」",
        text: "講評を聞きますか？",
        kana: "こうひょうをききますか？",
        romaji: "kouhyou wo kikimasu ka",
        reaction_good:
            "れい「お願いします」\n" +
            "ゆこ「……私は後で」",
        reaction_bad:
